...
namespace Kalmia.Infrastructure.Migrations
{
    ...
    partial class KalmiaDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kalmia.Core.Entities.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kalmia.Infrastructure.Identity.KalmiaUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kalmia.Core.Entities.Activity", b =>
                {
                    b.HasOne("Kalmia.Core.Entities.UserProfile", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Kalmia.Infrastructure.Identity.KalmiaUser", null)
                        .WithMany()
