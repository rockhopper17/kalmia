...
namespace Kalmia.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UserProfiles_HeightCm_NonNegative", "[HeightCm] >= 0");
                    table.CheckConstraint("CK_UserProfiles_WeightKg_NonNegative", "[WeightKg] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Activities_DistanceMeters_NonNegative", "[DistanceMeters] >= 0");
                    table.CheckConstraint("CK_Activities_DurationSeconds_NonNegative", "[DurationSeconds] >= 0");
                    table.CheckConstraint("CK_Activities_ElevationGainMeters_NonNegative", "[ElevationGainMeters] >= 0");
                    table.ForeignKey(
