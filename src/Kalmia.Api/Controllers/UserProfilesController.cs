...
{
    private readonly IUserProfileService _srvc;
    public UserProfilesController(IUserProfileService srvc) => _srvc = srvc;
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, UserProfileDto dto)
    {
